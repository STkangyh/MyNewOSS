def normalize_data(n_cases, n_people, scale):
    ...
    for idx, n in enumerate(n_cases):
        n = n_people[idx]
        norm_cases.append(scale*n_cases[idx]/n)
    return norm_cases
...
sum_people = sum_list(n_people) # TODO) The total number of people
sum_covid  = sum_list(n_covid) # TODO) The total number of new cases
...
print('* Total new casess:', sum_covid)
